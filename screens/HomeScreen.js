...
export default function HomeScreen() {
  ...
  const [institutions, setInstitutions] = useState(MaterialsData);
  ...
  const handleSearchChange = (searchQuery) => {
    ...
    const filteredInstitutions = MaterialsData.filter((institution) =>
    ...
    <SafeAreaView className="bg-bgWhite px-7 pt-5 pb-[-35px] flex-1">
      ...
      <View className="flex flex-row items-center justify-between">
        <View className="">
          ...
          <Text className="font-exo font-semibold text-lg"> John Doe</Text>
        </View>
